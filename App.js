...
import { downloadPDF, printPDF } from './services/pdfGenerator.js';
import type { LabelData, RawJsonItem, FieldMapping, MappingKey } from './types.js';
        ...
        {step === 1 && (
          <div className="flex flex-col items-center justify-center min-h-[60vh]">
            ...
            <div className="mt-16 text-xs text-gray-300">
               v1.1 (4-Field Layout / Fixed Deployment)
            </div>
          </div>
        )}
