...
export const ManualEntry: React.FC<ManualEntryProps> = ({ onDataLoaded }) => {
  ...
  // Opens a dedicated print window with A4-accurate label layout
  ...
  if (showPreview) {
    return (
      <div className="w-full max-w-5xl mx-auto">
        ...
        {/* Screen preview grid — mirrors print layout */}
        <div
          style={{
            display: 'grid',
        ...
        >
          {expandedLabels.map((item, idx) => (
            ...
            >
              <div style={{ color: '#e91e8c', fontWeight: 700, fontSize: '14px', textAlign: 'center', lineHeight: 1.25, textTransform: 'uppercase' }}>
                {item.dishName}
              </div>
              <div style={{ width: '70%', height: '1px', backgroundColor: '#e91e8c', margin: '8px 0' }} />
              <div style={{ fontWeight: 700, fontSize: '11px', textAlign: 'center', textTransform: 'uppercase', color: '#111827', letterSpacing: '0.08em' }}>
